...
class IngestService:
    ...
    def ingest_all(self, force_reprocess: bool = False) -> IngestResult:
        ...
        for pdf_path in pdf_files:
            # MUDANÇA: Calcular hash ANTES de processar
            file_hash = self._calculate_file_hash(pdf_path)
            
            # MUDANÇA: Carregar chunks ANTES de mover o arquivo
            chunks_for_this_doc = []
            if pdf_path.exists():
                try:
            ...
            # Só adiciona chunks se o processamento foi bem-sucedido
    ...
    def process_document(
        ...
        try:
            # 1. Calcula hash do arquivo (se não foi passado)
            ...
            # 4. Processa e cria chunks (só para contar)
    ...
    def _create_chunks(
        ...
        """
        Cria chunks a partir do texto extraído
        """
        all_chunks = []
        
        for page_num, text in pages_text:
            # Cria documento base para a página
            base_metadata = {
    ...
    def _index_chunks(self, chunks: List[Document]):
        ...
        # Verifica se vectorstore já existe
    ...
    def _infer_precedence(self, filename: str) -> int:
        """
        Infere nível de precedência baseado no tipo de documento
        """
